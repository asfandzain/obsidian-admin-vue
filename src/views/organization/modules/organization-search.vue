...
interface OrganizationSearchModel {
  keyword: string | null;
  status: Api.Common.EnableStatus | null;
}

const model = defineModel<OrganizationSearchModel>('model', { required: true });
...
<template>
  <NCard :bordered="false" size="small" class="card-wrapper">
    <NCollapse>
      <NCollapseItem :title="$t('common.search')" name="organization-search">
